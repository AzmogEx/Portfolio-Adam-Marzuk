...
<body>
    ...
    <div class="section text-light">
        <div class="text-center">
            ...
            <img id="macbook" src="img/Macbook-Pro---Copy1-1920x1080.png" loading="lazy" width="50%"
                sizes="(max-width: 479px) 94vw, (max-width: 767px) 96vw, (max-width: 1919px) 94vw, 1140px"
                alt="img-Macbook"
                srcset="img/Macbook-Pro---Copy1-1920x1080-p-500.png 500w, img/Macbook-Pro---Copy1-1920x1080-p-800.png 800w, img/Macbook-Pro---Copy1-1920x1080-p-1080.png 1080w, img/Macbook-Pro---Copy1-1920x1080-p-1600.png 1600w, img/Macbook-Pro---Copy1-1920x1080.png 1920w"
                class="macbook pt-5" />
                    ...
                    <div class="container col-xxl-8 px-4 py-5">
                        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                            <div class="col-12 col-lg-6">
                                <img src="img/moi.jpg" class="d-block mx-lg-auto img-fluid rounded-circle profil w-100"
                                    alt="Photo de profil (moi)" loading="lazy" />
                            </div>

                            <div class="col-lg-6">
                                <h1 class="display-5 fw-bold text-white lh-1 mb-3">👤 <span>Adam Marzuk</span></h1>
                                <p class="lead text-white">Je suis étudiant en <b><span>BTS SIO (Services informatiques
                                            aux organisations)</span></b> et passionné par l'informatique depuis le plus
                                    jeune âge, j'ai choisi ce domaine afin de me consacrer au développement logiciel.
                                </p>
                                <div
                                    class="cv-button-container justify-content-center d-flex flex-row align-items-baseline">
                                    <div class="cv-buttons-container" style="max-width: 150px;">
                                        <a href="https://cv.adam-marzuk.fr" target="_blank"
                                            class="button-cv text-center">CV FR</a>
                                        <a href="https://cv-en.adam-marzuk.fr" target="_blank"
                                            class="button-cv text-center">CV EN</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="competences" class="skills competences-section">
                <h1 id="stages-id"
                    class="heading-4 stages-class text-light border-bottom border-light border-5 text-left titre-section">
            ...
            <div class="experience-image text-center image-experience" id="experience">
                <h1 id="stages-id"
                    class="heading-4 stages-class text-light border-bottom border-light border-5 titre-section"><i
                        class="fa fa-user-o" aria-hidden="true"></i>
                    Mes experiences
                </h1>
                <img src="img/presentation.png" loading="lazy" sizes="(max-width: 1919px) 100vw, 1140px"
                    srcset="img/presentation-500.png 500w, img/presentation-800.png 800w, img/presentation-1080.png 1080w"
                    alt="image presentation" class="image-presentation" />
            </div>
        </div>
        <!--===============SECTION Projets===========-->
        <div id="projet-nav"></div>
        <h1 id="stages-id"
            class="heading-4 stages-class text-light border-bottom border-light border-5 text-left titre-section"><i
        ...
        <div id="projet" class="container-card-projet">
            <card data-image="img-projet/gare.png">
                ...
                <p slot="content">J'ai conçu un logiciel listant toutes les gares de France par département, incluant
                    des informations sur la prise en charge des passagers et le transport ferroviaire.</p>
            </card>
            <card data-image="img-projet/fromage.png">
                <h1 slot="header">Fromage de France</h1>
                <p slot="content">J'ai développé un logiciel répertoriant les différents fromages des régions
                    françaises, avec des liens vers les pages Wikipédia et des options d'achat.</p>
            </card>
            <card data-image="img-projet/region.png">
                <h1 slot="header">Région de France</h1>
                <p slot="content">J'ai créé un logiciel permettant de lister toutes les régions, départements et villes
                    de France avec un affichage cartographique et des coordonnées.</p>
            </card>
            <card id="kit-card" data-image="img-projet/kit-ia.png">
                <h1 slot="header">KIT IA</h1>
                <p slot="content">Nous avons développer un kit de prévention sur les ia pour une table ronde autour des
                    intelligence artificielle durant la digiweek de 2024.</p>
            </card>
            <card id="flowtech-card" data-image="img-projet/flowtech.png">
                <h1 slot="header">Flowtech AP1 - AP4</h1>
                <p slot="content">Projet de création d'une entreprise fictive FlowTech spécialisée dans le montage de
                    PC, réalisé en JavaScript, PHP, HTML et CSS. Cliquez dessu pour découvrir !</p>
            </card>
        ...
        <!--============== SECTION CARD BTS===========-->
        <h1 id="stages-id"
            class="heading-4 stages-class text-light text-left border-bottom border-light border-5 titre-section"><i
        ...
        <div id="bts" class="container-card-projet">
            <card id="zoovengers-card" data-image="img-projet/Zoovengers.png">
                ...
                <p slot="content">J'ai conçu une application mobile pour le muséum <br />C'est un escape game pour les
                    visiteurs. Elle est développée en Dart avec l'aide du framework Flutter.</p>
            </card>
            <card data-image="img-projet/Compteur.png">
                <h1 slot="header">Compteur</h1>
                <p slot="content">J'ai conçu une application pour les tablettes android du musée<br />permettant au
                    gardien des salles du musée de comptabiliser le nombre de visiteurs total de la journée et actuel en
                    temps réel.</p>
            </card>
            <!-- Carte Projet -->
            <card data-image="img-projet/musee.png" id="gestion-base-card">
                <h1 slot="header">Gestion de base de données</h1>
                <p slot="content">J'ai conçu un logiciel permettant d'ajouter des espèces dans le musée.</p>
            </card>

            <!-- Fenêtre modale -->
            <div class="modal fade" id="modalInformations" tabindex="-1" role="dialog"
                aria-labelledby="modalInformationsLabel" aria-hidden="true">
                <div class="modal-dialog text-black" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalInformationsLabel">Logiciel de gestion des espèces au
                                Muséum</h5>
                        ...
                        <div class="modal-body" id="modal-description">
                            <h6>Contexte et Objectif :</h6>
                            <p>
                                Dans le cadre de mon stage au Muséum d'Histoire Naturelle de Nîmes, j'ai développé un
                                logiciel de gestion de base de données permettant d'ajouter, modifier et visualiser des
                                espèces animales présentes dans le musée.
                            </p>

                            <h6>Fonctionnalités principales :</h6>
                            <ul>
                                <li>Ajout de nouvelles espèces avec des informations détaillées (nom scientifique,
                                    habitat, etc.).</li>
                                <li>Gestion des catégories d'espèces (mammifères, reptiles, oiseaux, etc.).</li>
                                <li>Filtrage et recherche d'espèces par caractéristiques spécifiques.</li>
                                <li>Interface utilisateur intuitive permettant une gestion simplifiée des données.</li>
                            </ul>

                            <h6>Technologies utilisées :</h6>
                            <p>
                                Le logiciel est développé en utilisant une base de données SQL Server avec Entity
                                Framework pour la gestion des données. L'interface utilisateur a été créée en WPF avec
                                C#, offrant une expérience fluide et réactive.
                            </p>

                            <h6>Impact pour le Muséum :</h6>
                            <p>
                                Ce logiciel améliore considérablement la gestion des collections du Muséum, en
                                permettant une mise à jour facile des informations sur les espèces. Il permet également
                                d'automatiser des processus qui étaient auparavant réalisés manuellement.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script src="/js/digiweek.js"></script>
        ...
        const startInitialPosition = {
            x: 0,
            y: 0
        };
        const endInitialPosition = {
            x: 0,
            y: 0
        };
        ...
        Draggable.create("#start", {
            ...
            onDragEnd: function() {
                gsap.to("#start", {
                    x: startInitialPosition.x,
                    y: startInitialPosition.y,
                    duration: 1
                });
            },
            onPress: function() {
